...
import { STUDENTS_STATUS_OPTIONS } from '../constants/studentsConstants.jsx';

/**
 * Toolbar for the students table — search input + status filter.
 * Isolated so the toolbar can be tested and extended independently.
 */
const StudentsToolbar = ({ search, statusFilter, onSearch, onStatusFilter }) => (
